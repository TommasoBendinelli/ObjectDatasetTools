...
def demo_manual_registration():
    ...
    cad = cad_mesh.sample_points_poisson_disk(10000)
    


    #source = o3d.io.read_triangle_mesh("scaledSiemens.ply")
    #source = source.sample_points_poisson_disk(2000)
    pcd = o3d.io.read_point_cloud("point_cloud/segmented/siemens5_segmented.ply")
    ...
    cad_mesh.translate(t)
    cad_mesh.transform(reg_p2p.transformation)
    # rot = reg_p2p.transformation[:3,:3]
    # trasl = reg_p2p.transformation[:3,3]
    # cad_mesh.translate(-trasl)
    o3d.visualization.draw_geometries([cad_mesh, target])
    o3d.io.write_triangle_mesh("mesh/siemens5.ply", cad_mesh)
